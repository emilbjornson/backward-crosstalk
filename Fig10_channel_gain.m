...
% Go through different receiver noise values
rangee=10:-5:-10;
for sigman2=db2pow(rangee)
    ...
    % Average SE values
    optimumm=[optimumm opt/1000];
    Mrt=[Mrt mr/1000];
    daMrt=[daMrt damr/1000];
end

% Plot optimumm, Mrt, and daMrt to obtain Fig. 10.